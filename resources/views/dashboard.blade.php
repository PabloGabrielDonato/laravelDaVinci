    ...
    <div class="row mx-auto gap-5 ">
        ...
        <section class="col-md-12 m-1">
            ...
            <article class="border p-2">
                <h4>Tus posts</h4>
                <a href="/post/crear" class="btn btn-success">Crear post</a>
                <div class="row">
                    ...
                    <div class="card col-5 m-2">
                        ...
                        <div class="card-footer d-flex justify-content-around">
                            <a href="/post/editar/{{ $post->id }}" class="btn btn-warning">Editar</a>
        ...
        @else
        <a href="/lawyer/create" class="btn btn-success mb-4 col-md-10">Crear perfil de abogado</a>
        @endif
    </div>
</main>
